...
SECRET_KEY = 'qoayafk(d+2$a6m4269pb!(8tw(=lxj%k)f-bi3hl20)r3b8gj'
...
STATUS_DATA_OPTIMIZATION ={
    'latest':[0,600],
    '30secs':[30,360],   #3hours
    '5mins':[300,288],   #1days
    '30mins': [1800, 300], #7days
    '60mins': [3600, 720], #30days
}
...
EMAIL_PORT = 25
EMAIL_HOST_USER = 'lizfg@126.com'
EMAIL_HOST_PASSWORD = 'QJL171012qjl'
DEFAULT_FROM_EMAIL = '11<lizfg@126.com>'
