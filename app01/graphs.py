...
class GraphGenerator2(object):
    ...
    def get_host_graph(self):
        ...
        for service_id,val_dic in service_data_dic.items():
            ...
            service_redis_key = "Status_%s_%s_%s" %(self.host_id,val_dic['name'],self.time_range)
...
class GraphGenerator(object):
    ...
    def get_graph_data(self):
        ...
        data_store_key = "Status_%s_%s_%s" %(self.host_id,self.service_name,self.time_range)
